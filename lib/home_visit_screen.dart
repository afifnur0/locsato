  ...
  Future<void> _submitSchedule() async {
    ...
    try {
      final response = await http.post(
        ...
        body: json.encode({
          'pet_id': selectedPetId, // Kirim ID Hewan
                ...
                if (visitHistory.isEmpty)
                   ...
                   ListView.builder(
                     ...
                     itemBuilder: (context, index) {
                       ...
                       // Penanganan Null Safety untuk UI
                           ...
                           child: Column(
                             ...
                             children: [
                               Row(
                                 ...
                                 children: [
                                   Text(visit['schedule'] ?? '-', style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.teal)),
                                   Container(
                                     ...
                                     child: Text(status.toUpperCase(), style: const TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: Colors.deepOrange)),
                                   )
                                 ],
                               ),
                               const SizedBox(height: 8),
                               ...
                               Text("Layanan: ${visit['services']}", style: TextStyle(color: Colors.grey.shade700)),
                               const Divider(),
                               Align(
                                 alignment: Alignment.centerRight,
                                 child: Text("Biaya: ${formatRupiah(visit['estimated_cost'] ?? 0)}", style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.orange)),
                               )
                             ],
                           ),
                         ),
